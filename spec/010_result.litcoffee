...
Чтобы можно было сообщение привязать к конкретному элементу систему, можно вместе с сообщением сохранять pathFunc.
...
обрабатывается, и уровень выше выдавать была ли ошибка внутри контекста, даже если внутри контекста был сброс
isResult в false.
