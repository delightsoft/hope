...
(function () {
  ...
  checkUDTypeName = _require2.checkUDTypeName;
  var _require2$err = _require2.err;
  tooManyArgs = _require2$err.tooManyArgs;
  invalidArg = _require2$err.invalidArg;
  invalidArgValue = _require2$err.invalidArgValue;
  isResult = _require2$err.isResult;
  Result = require('../result');

  var _require3 = require('../utils');

  checkEnumName = _require3.checkEnumName;
