...
(function () {
  ...
  sortedMap = require('../sortedMap'); //typeProps = ['length', 'enum', 'precision', 'scale', 'fields', 'refers', 'valueClass', 'nullable']
  ...
  'time', 'date', 'dateonly', 'now', 'json', 'blob', 'uuid', 'enum', 'structure', 'subtable', 'refers', 'dsvalue'];
    ...
    if (!(builtInTypes.indexOf(type) >= 0)) {
      if (reservedTypes.indexOf(type) >= 0) {
        ...
        result.context(function (path) {
          ...
          var i, len, prop, results; // udType can have nullable in a field definition
