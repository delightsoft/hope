...
(function () {
  var Result, builtInTypes, checkUDTypeName, compile, copyExtra, invalidArg, invalidArgValue, isResult, reservedTypes, setRequiredProp, sortedMap, takeBoolean, takeEnum, takePositiveInt, takeString, takeStringOrArrayOfStrings, tooManyArgs, typeProps;
  ...
  compile = function compile(result, fieldDesc, res, opts) {
    var enumProp, fieldsProp, i, j, len, len1, lengthProp, nullProp, options, optionsEnd, optionsIndex, optionsLen, optsContext, precisionProp, prop, refersProp, scaleProp, sourceType, type, valueClass;
