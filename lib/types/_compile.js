...
(function () {
  var Result, builtInTypes, checkItemName, compile, copyOptions, invalidArg, invalidArgValue, isResult, reservedTypes, setRequiredProp, sortedMap, takeBoolean, takeEnum, takePositiveInt, takeString, takeStringOrArrayOfStrings, tooManyArgs, typeProps;
  ...
  copyOptions = require('../config/_copyOptions'); //typeProps = ['length', 'enum', 'precision', 'scale', 'fields', 'refers', 'valueClass', 'null']
