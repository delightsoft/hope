...
(function () {
  var Result, builtInTypes, checkEnumName, checkUDTypeName, compile, copyExtra, invalidArg, invalidArgValue, isResult, reservedTypes, setRequiredProp, sortedMap, takeBoolean, takeEnum, takePositiveInt, takeString, takeStringOrArrayOfStrings, tooManyArgs, typeProps;
  ...
  builtInTypes = ['string', 'text', 'boolean', 'integer', 'double', 'decimal', 'time', 'date', 'dateonly', 'now', 'json', 'blob', 'uuid', 'enum', 'structure', 'subtable', 'refers', 'dsvalue'];
