...
(function () {
  var Result, _moment, _addValidate, moment, validate, validateStructure;
        ...
        if (type.hasOwnProperty('min')) {
          (function (pf) {
            ...
            f = function f(result, value) {
              ...
              if (!(!result.isError && min <= value.length)) {
                result.error('validate.tooShort', {
                  value: value,
                  min: min
                });
              }
        ...
        if (type.hasOwnProperty('regexp')) {
          (function (pf) {
            ...
            f = function f(result, value) {
              ...
              if (!(!result.isError && regexp.test(value))) {
                result.error('validate.invalidValue', {
                  value: value,
        ...
        if (type.hasOwnProperty('max')) {
          (function (pf) {
            ...
            f = function f(result, value) {
              ...
              if (!(!result.isError && value.length <= max)) {
                result.error('validate.tooLong', {
                  value: value,
                  max: max
                });
              }
        ...
        if (type.hasOwnProperty('min')) {
          (function (pf) {
            ...
            f = function f(result, value) {
              ...
              if (!(!result.isError && min <= value)) {
                result.error('validate.tooSmall', {
                  value: value,
                  min: min
                });
              }
        ...
        if (type.hasOwnProperty('max')) {
          (function (pf) {
            ...
            f = function f(result, value) {
              ...
              if (!(!result.isError && value <= max)) {
                result.error('validate.tooBig', {
                  value: value,
                  max: max
                });
              }
