          ...
          if (!fieldName.startsWith('$$')) {
            if (!type[fieldsProp].hasOwnProperty(fieldName)) {
              ...
              if (!viewMask.get(field.$$index)) {
                ...
                results.push(err = field.validate(result, fieldValue, value, viewMask, requiredMask, _typeof(field) === 'object' && field !== null && !Array.isArray(field) ? field.$$touched : void 0, strict) || err);
              } else {
                results.push(void 0);
              }
            }
