...
(function () {
  ...
  calc = function calc(result, collection, expression, options) {
    var _calcExpr2, clearVertical, expr, fieldMask, fixVertical, isFlat, level, levels, map, nextToken, optName, optValue, res, strict, tag, token;
    ...
    if (options !== void 0) {
      ...
      for (optName in options) {
        ...
        switch (optName) {
          ...
          case 'fixVertical':
            if (!(optValue === void 0 || typeof optValue === 'boolean')) {
              invalidOption('fixVertical', optValue);
            }

            if (optValue !== void 0) {
              fixVertical = optValue;
            }
          ...
          case 'clearVertical':
            if (!(optValue === void 0 || typeof optValue === 'boolean')) {
              invalidOption('clearVertical', optValue);
            }

            if (optValue !== void 0) {
              clearVertical = optValue;
            }

            break;

          default:
            throw new Error("Unknown option '".concat(optName, "': '").concat(optValue, "'"));
        }
      }
    }
    ...
    if (res) {
      // calc =
      if (isFlat && fixVertical) {
        res.fixVertical();
      }

      if (isFlat && clearVertical) {
        res.clearVertical();
      }
