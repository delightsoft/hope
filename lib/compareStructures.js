...
(function () {
  ...
  _compareMap = function _compareMap(result, path, actual, expected) {
    var k;
  ...
  _compareList = function _compareList(result, path, actual, expected) {
    var i;
  ...
  _compareValue = function _compareValue(result, path, actual, expected) {
    var atype, etype;
  ...
  compareStructures = function compareStructures(result, actual, expected) {
    _compareValue(result, [], actual, expected); // compareStructures =
