...
(function () {
  var Result, _compactValue, _compareList, _compareMap, _compareValue, compareStructures, prettyPrint;
  ...
  _compareMap = function _compareMap(result, path, actual, expected, severity) {
    ...
    if (!(path.indexOf(actual) >= 0)) {
      ...
      result.context(function (path) {
        return (expected.hasOwnProperty('$$list') && !k.startsWith('$') ? Result.prop : Result.prop)(k)(path);
      }, function () {
