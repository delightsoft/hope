...
(function () {
  ...
  BitArray = /*#__PURE__*/function () {
    ...
    _createClass(BitArray, [{
      ...
      value: function set(index, value) {
        var bitArray, i, j, len1, m, mask, r, ref, v;
      ...
      value: function fixVertical() {
        var i, item, itemMask, j, k, l, len1, mask, n, noSubfields, ref, ref1, ref2, ref3;

        if (this._edit) {
          mask = this._mask;
        } else {
          mask = new Array(this._mask.length);

          for (i = j = 0, ref = this._mask.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
            mask[i] = this._mask[i];
          }
        }
        ...
        for (k = 0, len1 = ref1.length; k < len1; k++) {
          ...
          if (this.get(item.$$index)) {
            if (noSubfields) {
              for (i = n = 0, ref3 = mask.length; n < ref3; i = n += 1) {
                mask[i] |= itemMask[i];
              }
            }
          } else if (!noSubfields) {
      ...
      value: function clearVertical() {
        var i, item, itemMask, j, k, l, mask, noSubfields, ref, ref1, ref2;
        ...
        for (k = ref1.length - 1; k >= 0; k += -1) {
          ...
          if (!(item.hasOwnProperty('$$mask') && mask[Math.trunc(item.$$index / 32)] | 1 << item.$$index % 32)) {
            continue;
          }
  ...
  Object.defineProperty(BitArray.prototype, 'only', {
    value: BitArray.prototype.and,
    enumerable: false,
    configurable: true
  }); // ----------------------------
