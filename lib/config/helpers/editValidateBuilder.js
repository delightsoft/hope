  ...
  $$editValidatorBuilderBuilder = function $$editValidatorBuilderBuilder(type, fieldsProp, access, docLevelValidate) {
    return function () {
      ...
      return function (fields, options) {
        var beforeAction, goodForAction, localResult, messages, oldSave, optName, optValue, r, save, validate;
        beforeAction = false;
        ...
        validate(localResult, fields, void 0, r.update, r.required, beforeAction ? void 0 : fields.$$touched, false, beforeAction);
        oldSave = save;
