...
(function () {
  ...
  _$$newBuilder = function $$newBuilder(fields) {
    var field, i, len, newFuncs, ref, ref1, tagSystem;
    tagSystem = (ref = fields.$$tags) != null ? ref.system : void 0;
    newFuncs = [];
    ref1 = fields.$$list;
    ...
    for (i = 0, len = ref1.length; i < len; i++) {
      ...
      if (!tagSystem || !tagSystem.get(field.$$index)) {
        (function () {
          var init, name;
          name = field.name;
          init = void 0;
