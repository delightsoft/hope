...
(function () {
  ...
  messages = {
    dsc: {
      unexpectedComputedJS: function unexpectedComputedJS(args) {
        return "Unexpected file ".concat(args.file, ". There are no computed fields in '").concat(args.doc, "'");
      },
      missingComputedJS: function missingComputedJS(args) {
        return "Missing file ".concat(args.file, ". There are computed fields in '").concat(args.doc, "'");
      },
      computedFieldWithinComputedField: function computedFieldWithinComputedField(args) {
        return "Field '".concat(args.field, "': There are computed field(s) inside the computed field");
      },
      unknownFieldInComputedCode: function unknownFieldInComputedCode(args) {
        return "".concat(args.file, ": Unknown field '").concat(args.field, "'");
      },
      fieldInComputedCodeIsNotTaggedAsComputed: function fieldInComputedCodeIsNotTaggedAsComputed(args) {
        return "".concat(args.file, ": Field '").concat(args.field, "' is not tagged as computed");
      },
      missingCodeForComputeField: function missingCodeForComputeField(args) {
        return "".concat(args.file, ": Missing '").concat(args.field, "' computed field implementation");
      },
