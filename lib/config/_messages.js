  ...
  messages = {
    dsc: {
      ambiguousProp: function ambiguousProp(args) {
        return "Ambiguous property ".concat(args.name, " values: ").concat(value1, " and ").concat(value2);
      },
      ...
      notApplicableForTheTypeProp: function notApplicableForTheTypeProp(args) {
        return "Property ".concat(args.name, " is not applicable for type ").concat(args.type);
      },
