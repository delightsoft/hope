...
(function () {
  var Result, builtInTypes, checkUDTypeName, compileType, copyExtra, extraProps, flatMap, processUdtypes, reservedTypes, typeProps;
  ...
  processUdtypes = function processUdtypes(result, config) {
    ...
    return result.context(Result.prop('udtypes'), function () {
      ...
      res = flatMap(result, config.$$src.udtypes, 'fields', {
      ...
      _processUdtype = function processUdtype(udt, stack) {
        ...
        var i, j, k, len, len1, len2, parent, prop, src, t;
