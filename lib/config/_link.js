    ...
    for (n = 0, len3 = ref3.length; n < len3; n++) {
      ...
      for (o = 0, len4 = ref4.length; o < len4; o++) {
        ...
        if (!noHelpers) {
          ...
          method.arguments.$$editValidateBuilder = $$editValidateBuilderBuilder(method, 'arguments', method.arguments.$$access, methods && methods.api[api.name] && methods.api[api.name][method.name] && methods.api[api.name][method.name].argValidate);
          ...
          method.result.$$editValidateBuilder = $$editValidateBuilderBuilder(method, 'result', method.arguments.$$access, methods && methods.api[api.name] && methods.api[api.name][method.name] && methods.api[api.name][method.name].resultValidate);
        }
