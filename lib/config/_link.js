  ...
  link = function link(config, noHelpers, opts) {
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (!noHelpers) {
        ...
        doc.fields.$$validate = $$validateBuilder(doc, 'fields', doc.$$access, methods != null ? (ref5 = methods.docs[doc.name]) != null ? ref5.validate : void 0 : void 0);
    ...
    for (n = 0, len3 = ref9.length; n < len3; n++) {
      ...
      for (o = 0, len4 = ref10.length; o < len4; o++) {
        ...
        if (!noHelpers) {
          ...
          method.arguments.$$validate = $$validateBuilder(method, 'arguments', method.arguments.$$access, methods != null ? (ref14 = methods.api) != null ? (ref15 = ref14[api.name]) != null ? (ref16 = ref15[method.name]) != null ? ref16.argValidE : void 0 : void 0 : void 0 : void 0);
          ...
          method.result.$$validate = $$validateBuilder(method, 'result', method.result.$$access, methods != null ? (ref23 = methods.api) != null ? (ref24 = ref23[api.name]) != null ? (ref25 = ref24[method.name]) != null ? ref25.resultValidate : void 0 : void 0 : void 0 : void 0);
