  ...
  link = function link(config, noHelpers, opts) {
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (!noHelpers) {
        ...
        doc.$$rights = $$rightsBuilder(doc, methods != null ? methods.rights : void 0, methods != null ? (ref5 = methods.docs) != null ? (ref6 = ref5[doc.name]) != null ? ref6.rights : void 0 : void 0 : void 0);
      ...
      if (!api.methods) {
        ...
        for (o = 0, len4 = ref14.length; o < len4; o++) {
          ...
          if (!noHelpers) {
            ...
            method.arguments.$$validate = $$validateBuilder(method, 'arguments', methods != null ? (ref18 = methods.api) != null ? (ref19 = ref18[api.name]) != null ? (ref20 = ref19[method.name]) != null ? ref20.argValidE : void 0 : void 0 : void 0 : void 0);
            ...
            method.result.$$editValidate = $$editValidateBuilder(method, 'result', method.arguments.$$access, methods != null ? (ref30 = methods.api) != null ? (ref31 = ref30[api.name]) != null ? (ref32 = ref31[method.name]) != null ? ref32.resultValidate : void 0 : void 0 : void 0 : void 0);
          }
