...
(function () {
  ...
  link = function link(config, noHelpers) {
    var EMPTY_FLAT_MAP, EMPTY_LIST, EMPTY_MAP, EMPTY_MAP_WITH_TAGS, EMPTY_MASK, EMPTY_TAGS, api, doc, freeze, freezeFields, j, l, len, len1, len2, len3, len4, linkFields, linkFlatMap, linkSortedMap, linkTags, linkUDTypes, m, method, n, o, ref, ref1, ref2, ref3, ref4, state, transition;
    ...
    linkFields = function linkFields(config, list) {
      var field, i, j, len, refName, udt, udtList;
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      freezeFields = function freezeFields(fields) {
        fields.$$list.forEach(function (field) {
          if (field.fields) {
            freeze(field.fields);
          }
        });
