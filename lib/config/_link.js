  ...
  link = function link(config, noHelpers, opts) {
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (!noHelpers) {
        ...
        doc.$$validate = doc.fields.$$validate = $$validateBuilder(doc, 'fields', methods != null ? (ref5 = methods.docs) != null ? (ref6 = ref5[doc.name]) != null ? ref6.validate : void 0 : void 0 : void 0);
        doc.$$editValidate = doc.fields.$$editValidate = $$editValidateBuilder(doc, 'fields', doc.$$access, methods != null ? (ref7 = methods.docs) != null ? (ref8 = ref7[doc.name]) != null ? ref8.validate : void 0 : void 0 : void 0);
      }

      ref9 = doc.states.$$list;
    ...
    ref11 = config.api.$$list;

    for (n = 0, len3 = ref11.length; n < len3; n++) {
      api = ref11[n];
      ...
      if (!api.methods) {
        ...
        ref12 = api.methods.$$list;

        for (o = 0, len4 = ref12.length; o < len4; o++) {
          method = ref12[o];
          ...
          if (!noHelpers) {
            method.arguments.$$access = $$accessBuilder(method, 'arguments', methods != null ? (ref13 = methods.api) != null ? (ref14 = ref13[api.name]) != null ? (ref15 = ref14[method.name]) != null ? ref15.argAccess : void 0 : void 0 : void 0 : void 0);
            method.arguments.$$validate = $$validateBuilder(method, 'arguments', methods != null ? (ref16 = methods.api) != null ? (ref17 = ref16[api.name]) != null ? (ref18 = ref17[method.name]) != null ? ref18.argValidE : void 0 : void 0 : void 0 : void 0);
            method.arguments.$$editValidate = $$editValidateBuilder(method, 'arguments', method.arguments.$$access, methods != null ? (ref19 = methods.api) != null ? (ref20 = ref19[api.name]) != null ? (ref21 = ref20[method.name]) != null ? ref21.argValidate : void 0 : void 0 : void 0 : void 0);
            method.result.$$access = $$accessBuilder(method, 'result', methods != null ? (ref22 = methods.api) != null ? (ref23 = ref22[api.name]) != null ? (ref24 = ref23[method.name]) != null ? ref24.resultAccess : void 0 : void 0 : void 0 : void 0);
            method.result.$$validate = $$validateBuilder(method, 'result', methods != null ? (ref25 = methods.api) != null ? (ref26 = ref25[api.name]) != null ? (ref27 = ref26[method.name]) != null ? ref27.resultValidate : void 0 : void 0 : void 0 : void 0);
            method.result.$$editValidate = $$editValidateBuilder(method, 'result', method.arguments.$$access, methods != null ? (ref28 = methods.api) != null ? (ref29 = ref28[api.name]) != null ? (ref30 = ref29[method.name]) != null ? ref30.resultValidate : void 0 : void 0 : void 0 : void 0);
          }
