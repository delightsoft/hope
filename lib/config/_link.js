...
(function () {
  var $$accessBuilder, $$calcBuilder, $$docAccessBuilder, $$editValidateBuilder, $$fixBuilder, $$getBuilder, $$newBuilder, $$rightsBuilder, $$setBuilder, $$updateBuilder, $$validateBuilder, $$vueDebugWatchBuilderBuilder, $$wasTouchedBuilder, BitArray, Result, addValidate, hasOwnProperty, isResult, link, snakeCase, validateStructure;
  ...
  link = function link(config, noHelpers, opts) {
        ...
        _buildMask = function buildMask(list) {
          ...
          for (j = 0, len = list.length; j < len; j++) {
            ...
            if (item.hasOwnProperty(prop)) {
              ...
              freezeBitArray(masks.pop()); // buildMask =
            }
          }
        };
    ...
    linkFieldsWithHelpers = function linkFieldsWithHelpers(obj, prop, prefix, isDoc) {
      var _assignKey, computed, field, j, l, len, len1, ref, ref1, ref2, ref3;

      obj[prop] = linkFlatMap(obj[prop], 'fields', false, false, true);
      linkFields(config, obj[prop].$$flat.$$list);

      if (!noHelpers) {
        if (isDoc && (computed = methods != null ? (ref = methods.docs) != null ? (ref1 = ref[obj.name]) != null ? ref1.computed : void 0 : void 0 : void 0)) {
          obj.fields.$$flat.$$list.forEach(function (field) {
            var computedMethod;

            if (computedMethod = computed[field.fullname || field.name]) {
              return field.$$computed = computedMethod;
            }
          });
        }

        _assignKey = function assignKey(fields, levelPrefix) {
          var field, j, len, nextLevelPrefix, ref2, results;
          ref2 = fields.$$list;
          results = [];
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (!noHelpers) {
        ...
        access = $$accessBuilder(doc, 'fields', methods != null ? (ref3 = methods.docs) != null ? (ref4 = ref3[doc.name]) != null ? ref4.access : void 0 : void 0 : void 0, true);

        if (rights = $$rightsBuilder(doc, methods != null ? methods.rights : void 0, methods != null ? (ref5 = methods.docs) != null ? (ref6 = ref5[doc.name]) != null ? ref6.rights : void 0 : void 0 : void 0)) {
          doc.$$rights = rights;
        }

        doc.$$access = $$docAccessBuilder(doc, access, rights);
        doc.$$validate = doc.fields.$$validate = $$validateBuilder(doc, 'fields', methods != null ? (ref7 = methods.docs) != null ? (ref8 = ref7[doc.name]) != null ? ref8.validate : void 0 : void 0 : void 0);
        doc.$$editValidate = doc.fields.$$editValidate = $$editValidateBuilder(doc, 'fields', doc.$$access, methods != null ? (ref9 = methods.docs) != null ? (ref10 = ref9[doc.name]) != null ? ref10.validate : void 0 : void 0 : void 0);
      }

      ref11 = doc.states.$$list;
    ...
    if (config.api) {
      ...
      ref13 = config.api.$$list;

      for (n = 0, len3 = ref13.length; n < len3; n++) {
        api = ref13[n];
        ...
        if (!api.methods) {
          ...
          for (o = 0, len4 = ref14.length; o < len4; o++) {
            ...
            if (!noHelpers) {
              method.arguments.$$access = $$accessBuilder(method, 'arguments', methods != null ? (ref15 = methods.api) != null ? (ref16 = ref15[api.name]) != null ? (ref17 = ref16[method.name]) != null ? ref17.argAccess : void 0 : void 0 : void 0 : void 0);
              method.arguments.$$validate = $$validateBuilder(method, 'arguments', methods != null ? (ref18 = methods.api) != null ? (ref19 = ref18[api.name]) != null ? (ref20 = ref19[method.name]) != null ? ref20.argValidate : void 0 : void 0 : void 0 : void 0);
              method.arguments.$$editValidate = $$editValidateBuilder(method, 'arguments', method.arguments.$$access, methods != null ? (ref21 = methods.api) != null ? (ref22 = ref21[api.name]) != null ? (ref23 = ref22[method.name]) != null ? ref23.argValidate : void 0 : void 0 : void 0 : void 0);
              method.result.$$access = $$accessBuilder(method, 'result', methods != null ? (ref24 = methods.api) != null ? (ref25 = ref24[api.name]) != null ? (ref26 = ref25[method.name]) != null ? ref26.resultAccess : void 0 : void 0 : void 0 : void 0);
              method.result.$$validate = $$validateBuilder(method, 'result', methods != null ? (ref27 = methods.api) != null ? (ref28 = ref27[api.name]) != null ? (ref29 = ref28[method.name]) != null ? ref29.resultValidate : void 0 : void 0 : void 0 : void 0);
              method.result.$$editValidate = $$editValidateBuilder(method, 'result', method.result.$$access, methods != null ? (ref30 = methods.api) != null ? (ref31 = ref30[api.name]) != null ? (ref32 = ref31[method.name]) != null ? ref32.resultValidate : void 0 : void 0 : void 0 : void 0);
            }
