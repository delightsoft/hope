  ...
  link = function link(config, noHelpers, opts) {
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (!noHelpers) {
        ...
        doc.$$rights = $$rightsBuilder(doc, methods != null ? methods.rights : void 0, typeof docs !== "undefined" && docs !== null ? (ref5 = docs[doc.name]) != null ? ref5.rights : void 0 : void 0);
        doc.$$validate = doc.fields.$$validate = $$validateBuilder(doc, 'fields', methods != null ? (ref6 = methods.docs) != null ? (ref7 = ref6[doc.name]) != null ? ref7.validate : void 0 : void 0 : void 0);
        doc.$$editValidate = doc.fields.$$editValidate = $$editValidateBuilder(doc, 'fields', doc.$$access, methods != null ? (ref8 = methods.docs) != null ? (ref9 = ref8[doc.name]) != null ? ref9.validate : void 0 : void 0 : void 0);
      }

      ref10 = doc.states.$$list;
    ...
    for (n = 0, len3 = ref12.length; n < len3; n++) {
      ...
      if (!api.methods) {
        ...
        for (o = 0, len4 = ref13.length; o < len4; o++) {
          ...
          if (!noHelpers) {
            method.arguments.$$access = $$accessBuilder(method, 'arguments', methods != null ? (ref14 = methods.api) != null ? (ref15 = ref14[api.name]) != null ? (ref16 = ref15[method.name]) != null ? ref16.argAccess : void 0 : void 0 : void 0 : void 0);
            method.arguments.$$validate = $$validateBuilder(method, 'arguments', methods != null ? (ref17 = methods.api) != null ? (ref18 = ref17[api.name]) != null ? (ref19 = ref18[method.name]) != null ? ref19.argValidE : void 0 : void 0 : void 0 : void 0);
            method.arguments.$$editValidate = $$editValidateBuilder(method, 'arguments', method.arguments.$$access, methods != null ? (ref20 = methods.api) != null ? (ref21 = ref20[api.name]) != null ? (ref22 = ref21[method.name]) != null ? ref22.argValidate : void 0 : void 0 : void 0 : void 0);
            method.result.$$access = $$accessBuilder(method, 'result', methods != null ? (ref23 = methods.api) != null ? (ref24 = ref23[api.name]) != null ? (ref25 = ref24[method.name]) != null ? ref25.resultAccess : void 0 : void 0 : void 0 : void 0);
            method.result.$$validate = $$validateBuilder(method, 'result', methods != null ? (ref26 = methods.api) != null ? (ref27 = ref26[api.name]) != null ? (ref28 = ref27[method.name]) != null ? ref28.resultValidate : void 0 : void 0 : void 0 : void 0);
            method.result.$$editValidate = $$editValidateBuilder(method, 'result', method.arguments.$$access, methods != null ? (ref29 = methods.api) != null ? (ref30 = ref29[api.name]) != null ? (ref31 = ref30[method.name]) != null ? ref31.resultValidate : void 0 : void 0 : void 0 : void 0);
          }
