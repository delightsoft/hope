...
(function () {
  var $$newBuilder, BitArray, Result, addValidate, calc, hasOwnProperty, isResult, link, validateStructure;
  ...
  link = function link(config, noHelpers, methods) {
    var EMPTY_FLAT_MAP, EMPTY_LIST, EMPTY_MAP, EMPTY_MAP_WITH_TAGS, EMPTY_MASK, EMPTY_TAGS, allAccess, api, apiKey, _deepFreeze, doc, docKey, freeze, j, l, len, len1, len2, len3, len4, linkFields, linkFieldsWithHelpers, linkFlatMap, linkSortedMap, linkTags, m, method, n, o, ref, ref1, ref2, ref3, ref4, ref5, state, transition;
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (!noHelpers) {
        ...
        if (!(doc.access = methods != null ? (ref1 = methods[doc.name]) != null ? ref1.access : void 0 : void 0)) {
          allAccess = {
            view: doc.fields.$$tags.all,
            update: doc.fields.$$tags.all,
            actions: doc.fields.$$tags.all
          };

          doc.$$access = function (doc, user) {
            return allAccess;
          };
        }
      }
