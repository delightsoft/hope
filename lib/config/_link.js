  ...
  link = function link(config, noHelpers) {
    ...
    for (n = 0, len3 = ref3.length; n < len3; n++) {
      ...
      for (o = 0, len4 = ref4.length; o < len4; o++) {
        ...
        if (!noHelpers) {
          (function () {
            var validateArguments, validateResult;
            validateArguments = validateStructure(method, 'arguments');

            method.arguments.$$validate = function (result, fields) {
              return validateArguments(result, fields);
            };

            validateResult = validateStructure(method, 'result');

            method.result.$$validate = function (result, fields) {
              return validateResult(result, fields);
            };
          })();
        }
