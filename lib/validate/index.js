      ...
      if (this.beforeAction) {
        ...
        this.result.context(function (path) {
          ...
          for (j = 0, len1 = ref.length; j < len1; j++) {
            ...
            if ((!_this.mask || _this.mask.get(field.$$index)) && (field.required || ((ref1 = _this.requiredMask) != null ? ref1.get(field.$$index) : void 0)) && !value.hasOwnProperty(field.name) && (!onlyFields || onlyFields[field.name])) {
        ...
        case 'string':
          (function (len) {
            return f = function f(value) {
              ...
              if (this.beforeAction && value.length === 0 && (fieldDesc.required || ((ref = this.requiredMask) != null ? ref.get(fieldDesc.$$index) : void 0))) {
          ...
          if (fieldDesc.hasOwnProperty('max')) {
            (function (pf) {
              ...
              f = function f(value) {
                ...
                if (this.beforeAction && !(value.length <= max)) {
                  return this.result.error('validate.tooLong', {
                    value: value,
                    max: max
                  });
        ...
        case 'subtable':
          return function () {
            ...
            return function (value, fieldsLevel, doc, onlyFields) {
              ...
              if ((fieldDesc.required || ((ref = this.requiredMask) != null ? ref.get(fieldDesc.$$index) : void 0)) && value.length === 0) {
                return this.result.error('validate.invalidValue', {
                  value: value
                });
              }
    ...
    if (fieldDesc["null"]) {
      (function (pf) {
        return f = function f(value) {
          ...
          } else if (this.beforeAction && (fieldDesc.required || ((ref = this.requiredMask) != null ? ref.get(fieldDesc.$$index) : void 0))) {
            return this.result.error('validate.requiredField', {
              value: value
            });
          }
