          ...
          if (!fieldName.startsWith('$$')) {
            if (!type[fieldsProp].hasOwnProperty(fieldName)) {
              ...
              if (!viewMask.get(field.$$index)) {
                ...
                results.push(err = field._validate(result, fieldValue, value, viewMask, requiredMask, onlyFields ? _typeof(fieldValue) === 'object' && fieldValue !== null && !Array.isArray(fieldValue) ? fieldValue.$$touched : {} : void 0, strict) || err);
              } else {
                results.push(void 0);
              }
            }
