...
(function () {
  ...
  validateStructureBuilder = function validateStructureBuilder(type) {
    ...
    return function (result, value, fieldsLevel, mask, requiredMask, onlyFields, strict, beforeActiom) {
          ...
          if (!(fieldName[0] === '$' || fieldName[0] === '_')) {
            if (!type[fieldsProp].hasOwnProperty(fieldName)) {
              ...
              if (!(!mask || mask.get(field.$$index))) {
                ...
                results.push(err = field._validate(result, fieldValue, value, mask, requiredMask, onlyFields ? _typeof(fieldValue) === 'object' && fieldValue !== null && !Array.isArray(fieldValue) ? fieldValue.$$touched : emptyOnlyFields : void 0, strict, beforeActiom) || err);
              } else {
                results.push(void 0);
              }
            }
      ...
      if (beforeActiom) {
        ...
        result.context(function (path) {
          ...
          for (j = 0, len1 = ref.length; j < len1; j++) {
            ...
            if ((!mask || mask.get(field.$$index)) && (field.required || requiredMask && requiredMask.get(field.$$index)) && (!value.hasOwnProperty(field.name) || value[field.name] === null) && (!onlyFields || onlyFields[field.name])) {
  ...
  validate = function validate(fieldDesc, fields, validators) {
    ...
    f = function () {
      switch (fieldDesc.type) {
        case 'string':
          (function (len) {
            return f = function f(result, value, fieldsLevel, mask, requiredMask, onlyFields, strict, beforeAction) {
              ...
              if (beforeAction && value.length === 0 && (fieldDesc.required || requiredMask && requiredMask.get(fieldDesc.$$index))) {
          ...
          if (fieldDesc.hasOwnProperty('min')) {
            (function (pf) {
              ...
              f = function f(result, value, fieldsLevel, mask, requiredMask, onlyFields, strict, beforeAction) {
                var r;

                if (r = pf(result, value, fieldsLevel, mask, requiredMask, onlyFields, strict, beforeAction)) {
                  return r;
                }
        ...
        case 'subtable':
          return function () {
            ...
            return function (result, value, fieldsLevel, mask, requiredMask, onlyFields, strict, beforeAction) {
              var err, i;
              ...
              result.context(function (path) {
                ...
                for (i = j = 0, len1 = value.length; j < len1; i = ++j) {
                  row = value[i];
                  results.push(err = validateStructure(result, row, void 0, mask, requiredMask, onlyFields ? row.$$touched : void 0, strict, beforeAction) || err);
                }
        ...
        default:
          return function (result, value, mask, requiredMask, strict) {
            return {};
          };
      }
    }();
    ...
    if (customValidator) {
      (function (pf) {
        return f = function f(result, value, fieldsLevel, mask, requiredMask, onlyFields, strict) {
          var r;

          if (r = pf(result, value, fieldsLevel, mask, requiredMask, onlyFields, strict)) {
            return r;
          }
